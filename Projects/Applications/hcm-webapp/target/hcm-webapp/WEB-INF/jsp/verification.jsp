		...
		<div class="masthead center-block">
			...
			<div class="panel panel-default">
				...
				<h2 style="text-align: center;">
					<label>Create <b>jTech</b> Account</label>
				</h2>
			</div>
			<div class="panel panel-default">
				<div id="product-dropdown" class="dropdown panel-heading">
				
				<h4>Great! <b>Your</b> account has been created! The last step is to verify your email address. You'll shortly receive a verification email.</h4>
