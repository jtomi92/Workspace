		...
		<div class="masthead center-block">
			...
			<div class="panel panel-default">
				...
				<h2 style="text-align: center;">
					<label>${localization['create-account']}</label>
				</h2>
			</div>
			<div class="panel panel-default">
				<div id="product-dropdown" class="dropdown panel-heading">
					...
					<h4>
						${localization['content-1']}<a
							href="${pageContext.request.contextPath}/console">${localization['content-2']}</a>${localization['content-3']}
					</h4>
