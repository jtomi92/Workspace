													...
													<c:forEach items="${relaysetting.productControlSettings}"
														...
														<c:if test="${(pcs.userId eq userid) && pcs.isAccess()}">
															<tr class="${userProduct.serialNumber}-relay-setting"
																...
																style="display: none;">
																<td id="${userProduct.serialNumber}-moduleid-${count2.index}">${relaysetting.moduleId}</td>
																<td id="${userProduct.serialNumber}-relayid-${count2.index}">${relaysetting.relayId}</td>
																<td><input
											...
											<div class="${userProduct.serialNumber}-relay-timer thumbnail"
														...
														<tr style="border-style: hidden;">
															...
															<td><div class="dropup">
																	<select
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'mon')}">
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'tue')}">
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'wed')}">
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'thu')}">
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'fri')}">
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'sat')}">
																		...
																		<c:choose>
																			<c:when
																				test="${fn:containsIgnoreCase(weekday,'sun')}">
														...
														<tr>
															...
															<td><div class="dropup">
																	<select
																		...
																		<c:set var="weekday"
																			value="${timerSetting.endWeekDays}" />
															...
															<td><c:if
																	...
																	<div
																		id="remove-setting-progressbar-${userProduct.serialNumber}-${relaysetting.moduleId}-${relaysetting.relayId}-${timerSetting.timerId}"
												...
												<c:if test="${lastItem == count3.count}">
													<div style="text-align: right;">
														...
														<div
															id="add-setting-progressbar-${userProduct.serialNumber}-${relaysetting.moduleId}-${relaysetting.relayId}"
								...
								<c:choose>
									<c:when test="${privilige eq 'ADMIN'}">
										<div style="display: none;"
											id="save-progressbar-${userProduct.serialNumber}" class="loader"
											id="timex"></div>
